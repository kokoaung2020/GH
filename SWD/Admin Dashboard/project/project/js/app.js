...
$(function () {
    $('[data-toggle="popover"]').popover();     //popover feather-info item_add.html
  });
...
if(currentMenuHeight > screenHeight*0.8){
    $(".sidebar").animate({
        scrollTop:currentMenuHeight        //You can put -value after the currentMenuHeight to control height
    },1000)
}